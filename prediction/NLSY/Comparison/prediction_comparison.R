...
setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/AMELIA")

load('amelia_NLSY10_fin.RData')
load('amelia_NLSY10_fin_copy.RData')

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/MICE")

load('MICE_NLSY10.RData')
load('MICE_NLSY10_copy.RData')

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/TRACE")

trace = read.csv("Trace_NLSY10.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY10.csv")
...
save(l.tr10, l.rnk10, l.aml10, l.mice10, LOSSAML10, LOSSMICE10, LOSSTRACE10,  LOSSRANK10 , file = "all_NLSY10.RData")
...
trace = read.csv("Trace_NLSY20.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY20.csv")
...
save(l.tr20, l.rnk20, l.aml20, l.mice20, LOSSAML20, LOSSMICE20, LOSSTRACE20,  LOSSRANK20 , file = "all_NLSY20.RData")
...
trace = read.csv("Trace_NLSY30.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY30.csv")
...
save(l.tr30, l.rnk30, l.aml30, l.mice30, LOSSAML30, LOSSMICE30, LOSSTRACE30,  LOSSRANK30 , file = "all_NLSY30.RData")
...
trace = read.csv("Trace_NLSY40.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY40.csv")
...
save(l.tr40, l.rnk40, l.aml40, l.mice40, LOSSAML40, LOSSMICE40, LOSSTRACE40,  LOSSRANK40 , file = "all_NLSY40.RData")
...
trace = read.csv("Trace_NLSY50.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY50.csv")
...
save(l.tr50, l.rnk50, l.aml50, l.mice50, LOSSAML50, LOSSMICE50, LOSSTRACE50,  LOSSRANK50 , file = "all_NLSY50.RData")
...
trace = read.csv("Trace_NLSY60.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY60.csv")
...
save(l.tr60, l.rnk60, l.aml60, l.mice60, LOSSAML60, LOSSMICE60, LOSSTRACE60,  LOSSRANK60 , file = "all_NLSY60.RData")
...
trace = read.csv("Trace_NLSY70.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY70.csv")
...
save(l.tr70, l.rnk70, l.aml70, l.mice70, LOSSAML70, LOSSMICE70, LOSSTRACE70,  LOSSRANK70 , file = "all_NLSY70.RData")
...
trace = read.csv("Trace_NLSY80.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY80.csv")
...
save(l.tr80, l.rnk80, l.aml80, l.mice80, LOSSMICE80, LOSSTRACE80,  LOSSRANK80 , file = "all_NLSY80.RData")
...
trace = read.csv("Trace_NLSY90.csv")

setwd("/Users/Nandana/Desktop/GitHub folder/MissingValues/Apr 2017/prediction/NLSY/RANK")


rank = read.csv("Rank_NLSY90.csv")
...
save(l.tr90, l.rnk90, l.aml90, l.mice90, LOSSMICE90, LOSSTRACE90,  LOSSRANK90 , file = "all_NLSY90.RData")
...
quartz()
pdf("columnwise_technique_nlsy.pdf")
par(mfrow = c(3,3))
